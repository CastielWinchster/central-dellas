    ...
    <div className="min-h-screen bg-[#0D0D0D] pb-24 md:pb-10">
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        <Card className="p-6 bg-[#1A1A1A] border-[#F472B6]/20 rounded-2xl mb-6">
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-[#0D0D0D] border-[#F472B6]/20 text-[#F2F2F2] pr-10"
          ...
          {/* Requirements */}
          {newPassword && (
            <Card className="mt-4 p-4 bg-[#0D0D0D] border-[#F472B6]/10 rounded-xl">
        ...
        <div className="mt-4 text-center">
          <button
            ...
            className="text-sm text-[#F472B6] hover:text-[#EC4899] transition-colors"
          >
            Esqueci minha senha
          </button>
        </div>
