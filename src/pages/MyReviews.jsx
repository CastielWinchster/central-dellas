...
export default function MyReviews() {
  ...
  const badges = [
    ...
    { icon: Heart, label: 'Favorita', description: 'Mais de 50 corridas repetidas', color: 'from-[#EC4899] to-[#F472B6]' },
    { icon: Sparkles, label: 'Estrela Nascente', description: '100 corridas 5 estrelas', color: 'from-pink-400 to-pink-500' }
  ];
  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] text-[#F2F2F2] pb-24 md:pb-10">
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        >
          <Card className="p-8 rounded-3xl bg-gradient-to-br from-[#EC4899]/20 to-[#F472B6]/20 border-[#F472B6]/20 mb-6">
                  ...
                  return (
                    <div key={star} className="flex items-center gap-3">
                      ...
                      <Progress value={percentage} className="h-2 flex-1 bg-[#F2F2F2]/10">
                        <div 
                          className="h-full bg-gradient-to-r from-[#EC4899] to-[#F472B6] rounded-full transition-all"
        ...
        >
          <Card className="p-6 rounded-3xl bg-[#F2F2F2]/5 border-[#F472B6]/10 mb-6">
        ...
        >
          <Card className="p-6 rounded-3xl bg-[#F2F2F2]/5 border-[#F472B6]/10 mb-6">
            <h3 className="text-lg font-semibold text-[#F2F2F2] mb-4 flex items-center gap-2">
              <ThumbsUp className="w-5 h-5 text-[#F472B6]" />
              Elogios Frequentes
            </h3>
            <div className="flex flex-wrap gap-3">
              {tags.map((tag, index) => (
                <motion.span
                  ...
                  className="px-4 py-2 rounded-full bg-[#F472B6]/10 border border-[#F472B6]/30 text-[#F2F2F2] text-sm flex items-center gap-2"
                >
                  {tag.label}
                  <span className="px-2 py-0.5 rounded-full bg-[#F472B6]/20 text-xs text-[#F472B6]">
                    {tag.count}
                  </span>
                </motion.span>
              ))}
            ...
            <div className="space-y-6">
              {reviews.map((review, index) => (
                <motion.div
                  ...
                  className="pb-6 border-b border-[#F472B6]/10 last:border-0 last:pb-0"
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="relative mb-3">
                        <Quote className="absolute -left-1 -top-1 w-4 h-4 text-[#F472B6]/30" />
                      ...
                      <div className="flex flex-wrap gap-2">
                        {review.tags.map((tag, tagIndex) => (
                          <span 
                            key={tagIndex}
                            className="px-3 py-1 rounded-full bg-[#F472B6]/10 text-[#F472B6] text-xs"
                          >
                            ✨ {tag}
                          </span>
                        ))}
