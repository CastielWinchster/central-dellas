    ...
    <div className="min-h-screen bg-[#0D0D0D] text-[#F2F2F2] py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-2">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#EC4899] to-[#F472B6] flex items-center justify-center">
        ...
        {/* Intro */}
        <div className="bg-[#1a1a1a] border border-[#F472B6]/20 rounded-2xl p-6 mb-6">
        ...
        <div className="bg-[#1a1a1a] border border-[#F472B6]/20 rounded-2xl p-6 mb-6">
          ...
          <h3 className="font-medium text-[#F472B6] mb-2">Opção 1 — Pelo aplicativo</h3>
          ...
          <h3 className="font-medium text-[#F472B6] mb-2">Opção 2 — Por e-mail</h3>
          ...
          <div className="space-y-2">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-3 rounded-xl bg-gradient-to-r from-[#EC4899] to-[#F472B6] text-white font-medium hover:opacity-90 transition"
            >
