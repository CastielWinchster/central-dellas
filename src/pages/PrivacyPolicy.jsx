  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] text-[#F2F2F2] pb-16">
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        <h1 className="text-3xl font-bold text-[#F22998] mb-2">Política de Privacidade</h1>
        ...
        <div className="space-y-8 text-[#F2F2F2]/80 leading-relaxed">
          ...
          <section>
            ...
            <p>
              O <strong className="text-[#F22998]">CentralDellas</strong> é um aplicativo de transporte por aplicativo que conecta passageiros e motoristas de forma segura. Nossa sede está localizada em Orlândia, SP, Brasil. Este documento descreve como coletamos, usamos e protegemos seus dados pessoais.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mt-3 p-4 rounded-xl bg-[#F22998]/10 border border-[#F22998]/20">
              ...
              <p>E-mail: <a href="mailto:privacidade@centraldellas.com.br" className="text-[#F22998] hover:underline">privacidade@centraldellas.com.br</a></p>
