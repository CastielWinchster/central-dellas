  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] text-[#F2F2F2] pb-16">
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        <h1 className="text-3xl font-bold text-[#F472B6] mb-2">Termos de Serviço</h1>
        ...
        <div className="space-y-8 text-[#F2F2F2]/80 leading-relaxed">
          ...
          <section>
            ...
            <p>
              O <strong className="text-[#F472B6]">CentralDellas</strong> é uma plataforma de transporte por aplicativo que conecta passageiros a motoristas parceiros. O app facilita a solicitação e gestão de corridas urbanas, intermunicipais e entregas na região de Orlândia, SP e cidades vizinhas.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <div className="mt-3 p-4 rounded-xl bg-[#F472B6]/10 border border-[#F472B6]/20">
              ...
              <p>E-mail: <a href="mailto:contato@centraldellas.com.br" className="text-[#F472B6] hover:underline">contato@centraldellas.com.br</a></p>
