...
export default function DriverOptions() {
  ...
  return (
    <div className="fixed inset-0 bg-[#0D0D0D] flex flex-col">
      {/* Fixed Header */}
      <div className="flex-shrink-0 bg-[#0D0D0D] border-b-2 border-[#BE185D] p-4 sticky top-0 z-50">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
        <div className="max-w-4xl mx-auto px-4 py-6 pb-32">
          ...
          <motion.div
            ...
            className="mb-6 p-6 rounded-2xl bg-[#1A1A1A] border border-[#BE185D]"
          >
            <div className="flex items-center gap-4">
              <div className="relative flex-shrink-0">
                <div className="w-20 h-20 min-w-[80px] rounded-full overflow-hidden border-4 border-[#F472B6]">
                  {user.photo_url ? (
                ...
                <label className="absolute bottom-0 right-0 w-7 h-7 rounded-full bg-[#F472B6] flex items-center justify-center cursor-pointer hover:bg-[#EC4899] transition-colors">
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <h3 className="text-xs font-bold text-[#BE185D] mb-3 uppercase tracking-wider px-2">
              📞 TELEFONE DE CONTATO
            </h3>
            <div className="bg-[#1A1A1A] border border-[#BE185D] rounded-2xl p-4">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-12 h-12 rounded-xl bg-[#F472B6]/20 flex items-center justify-center flex-shrink-0">
                  <Phone className="w-6 h-6 text-[#F472B6]" />
                </div>
                <div className="flex-1">
              ...
              <input
                ...
                className="w-full bg-[#2A2A2A] border border-[#F472B6]/20 rounded-xl px-4 py-3 text-[#F2F2F2] placeholder-[#F2F2F2]/30 focus:outline-none focus:border-[#F472B6]/60 mb-2"
              />
              {phoneError && (
          ...
          {menuSections.map((section, sectionIndex) => (
            ...
            >
              ...
              <div className="bg-[#1A1A1A] border border-[#BE185D] rounded-2xl overflow-hidden">
                {section.items.map((item, index) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-xl bg-[#F472B6]/20 flex items-center justify-center group-hover:bg-[#F472B6]/30 transition-colors">
