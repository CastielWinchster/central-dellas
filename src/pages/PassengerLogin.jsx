...
import { User, Mail, Lock, Eye, EyeOff, Shield, Heart } from 'lucide-react';
        ...
        >
          ...
          <div className="flex items-center gap-4 justify-center lg:justify-start">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[#F2F2F2]/60">Só mulheres</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          <Card className="p-8 bg-[#F2F2F2]/5 border-[#F22998]/20">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-[#F2F2F2]">Login de Passageira</h2>
            ...
            <form onSubmit={(e) => {
              ...
              <Button type="submit" className="w-full btn-gradient py-6 text-lg">
                Entrar como Passageira
              </Button>
            </form>

            <div className="mt-6 text-center">
              <Link to={createPageUrl('DriverLogin')} className="text-[#F22998] hover:underline">
            ...
            <div className="mt-6 text-center">
              <p className="text-[#F2F2F2]/60 text-sm">
                Ainda não tem conta?{' '}
                <button 
                  onClick={() => base44.auth.redirectToLogin(window.location.origin + createPageUrl('PassengerHome'))}
