        ...
        <Card className="p-6 bg-[#1A1A1A] border-[#F472B6]/20 rounded-2xl mb-6">
          <div className="flex flex-col items-center">
            <div className="relative mb-4">
              <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-[#F472B6]">
                {formState.photo_url ? (
              ...
              <label className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-[#F472B6] flex items-center justify-center cursor-pointer hover:bg-[#EC4899] transition-colors">
        ...
        <Card className="p-6 bg-[#1A1A1A] border-[#F472B6]/20 rounded-2xl mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Button
              ...
              size="sm"
              variant="ghost"
              className="text-[#F472B6] hover:bg-[#F472B6]/10"
            >
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="p-3 bg-[#0D0D0D] border border-[#F472B6]/20 rounded-xl text-[#F2F2F2]">
                {formState.full_name || '-'}
              </div>
            </div>
        ...
        {editingSection === 'info' && (
          ...
          >
            <motion.div
              ...
              className="bg-[#1A1A1A] rounded-2xl border border-[#F472B6]/20 p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto"
            >
              ...
              <div className="space-y-4 mb-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full p-3 bg-[#0D0D0D] border border-[#F472B6]/20 rounded-xl text-[#F2F2F2]"
                  >
              ...
              <div className="flex gap-3">
                <Button
                  onClick={closeEdit}
                  variant="outline"
                  className="flex-1 border-[#F472B6]/20 text-[#F2F2F2]"
                >
                  Cancelar
                </Button>
                <Button
                  onClick={saveInfo}
                  disabled={saving}
                  className="flex-1 bg-gradient-to-r from-[#EC4899] to-[#F472B6] text-white"
                >
