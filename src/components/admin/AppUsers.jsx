  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-3">
        <Card className="bg-[#F2F2F2]/5 border-[#F22998]/10 p-4 text-center">
          <UserCheck className="w-6 h-6 text-[#F22998] mx-auto mb-1" />
      ...
      <Card className="bg-[#F2F2F2]/5 border-[#F22998]/10 p-4">
        <div className="flex items-center gap-2">
          <Search className="w-4 h-4 text-[#F22998] flex-shrink-0" />
          <Input
      ...
      <div className="space-y-2">
        {filtered.map((u) => (
          <Card key={u.id} className="bg-[#F2F2F2]/5 border-[#F22998]/10 p-4">
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3 min-w-0">
                <div className="w-11 h-11 rounded-full overflow-hidden flex-shrink-0 bg-gradient-to-br from-[#BF3B79] to-[#8C0D60] flex items-center justify-center">
                  {u.photo_url
              ...
              <div className="flex flex-col items-end gap-1 flex-shrink-0">
                <div className="flex gap-1">
                  {u.role === 'admin' && <Badge className="bg-[#F22998]">Admin</Badge>}
