    ...
    <Card className="bg-[#F2F2F2]/5 border-[#F472B6]/10 p-6">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              className="bg-[#F472B6] hover:bg-[#EC4899]"
            >
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger className="bg-[#0D0D0D] border-[#F472B6]/20 text-white">
        ...
        <Button
          ...
          disabled={loading}
          className="w-full py-6 bg-gradient-to-r from-[#EC4899] to-[#F472B6] hover:opacity-90 text-white font-bold text-lg"
        >
