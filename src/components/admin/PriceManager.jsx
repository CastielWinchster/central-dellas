    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        ...
        <Input
          ...
          className="bg-[#0D0D0D] border-[#F472B6]/20 text-white pl-9"
        />
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-4">
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <Card className="bg-[#F2F2F2]/5 border-[#F472B6]/10 p-5">
          <div className="flex items-center gap-2 mb-4">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#EC4899] to-[#F472B6] flex items-center justify-center">
      ...
      <Button
        onClick={save}
        disabled={saving}
        className="w-full py-6 bg-gradient-to-r from-[#EC4899] to-[#F472B6] hover:opacity-90 text-white font-bold"
      >
        <Save className="w-5 h-5 mr-2" />
        {saving ? 'Salvando...' : 'Salvar Preços'}
      </Button>

      <Card className="bg-[#F472B6]/5 border-[#F472B6]/10 p-4 flex items-start gap-3">
        <DollarSign className="w-5 h-5 text-[#F472B6] mt-0.5 shrink-0" />
