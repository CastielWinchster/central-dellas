...
export default function CRLVCard({ status = 'pending' }) {
        ...
        {open && (
          ...
          >
            <div className="px-5 pb-5 border-t border-[#F22998]/10 pt-4 grid gap-4">
              <DocUploadField label="Foto do CRLV" />
              <div className="grid grid-cols-2 gap-4">
                <DocTextField label="Placa" placeholder="Ex: ABC-1234" />
                <DocTextField label="Renavam" placeholder="Ex: 00123456789" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <DocTextField label="Marca" placeholder="Ex: Toyota" />
                <DocTextField label="Modelo" placeholder="Ex: Corolla" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <DocTextField label="Ano" placeholder="Ex: 2022" type="number" />
                <DocTextField label="Nome do proprietário" placeholder="Nome completo" />
              </div>
            </div>
          </motion.div>
        )}
