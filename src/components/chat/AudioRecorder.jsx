  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        exit={{ opacity: 0, y: 20 }}
        className="absolute bottom-0 left-0 right-0 bg-[#1A1A1A] border-t border-[#BE185D] p-4"
      >
          ...
          {!audioBlob ? (
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 bg-[#0D0D0D] rounded-2xl p-4 flex items-center gap-3">
                <div className="text-[#F472B6] font-mono text-lg">
                  {formatTime(duration)}
                </div>
                ...
                <div className="flex-1 flex items-center gap-1 h-10">
                  {waveformData.slice(0, 32).map((value, i) => (
                    <motion.div
                      key={i}
                      className="flex-1 bg-[#F472B6] rounded-full"
                      style={{
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 bg-[#0D0D0D] rounded-2xl p-4">
                <div className="flex items-center gap-3">
                  <div className="text-[#F472B6] font-mono">
                    {formatTime(duration)}
                  </div>
