    ...
    <div className="space-y-4">
      <div>
        ...
        <div className="relative">
          <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#F472B6]" />
          <Input
            ...
            className={`pl-10 pr-10 bg-[#0D0D0D] ${
              value && allRequirementsMet ? 'border-green-500' : 'border-[#F472B6]/30'
            } text-[#F2F2F2] focus:border-[#F472B6]`}
            required
            maxLength={128}
          />
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 text-[#F472B6]"
          >
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`pl-10 pr-10 bg-[#0D0D0D] ${
                ...
                confirmPassword && !passwordsMatch ? 'border-red-500' : 'border-[#F472B6]/30'
              } text-[#F2F2F2] focus:border-[#F472B6]`}
              required
            />
            <button
